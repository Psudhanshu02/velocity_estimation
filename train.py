...
USE_WANDB = False
RAW_IMAGES_DIRECTORY = "/home/fatninja/Desktop/projects/velocityEstimation/velocity_estimation/data/train_raw"
PROCESSED_IMAGES_DIRECTORY = "/home/fatninja/Desktop/projects/velocityEstimation/velocity_estimation/data/train"
DATA_ROOT_DIR = "./data"
RUN_TRAINING = True
...
train_labels = []
with open(f"//home/fatninja/Desktop/projects/velocityEstimation/velocity_estimation/data/train.txt") as _f:
    _lines = _f.readlines()
    for v in _lines:
...
if USE_WANDB:
    login(key="2d41f704c63d2af786711c4d74535c8531338444")
...
def save_model(dir: str, 
    ...
    torch.save(model.state_dict(), f"{dir}/_{epoch}.pt")
...
if USE_WANDB:
	wandb.watch(model.OpticalFlowConvolutionalNetwork(), log="all")
